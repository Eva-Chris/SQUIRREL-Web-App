...
groupsIds = readGroups('files/5DiffGroupsTrain.txt')
...
for gr in groupsIds:
    ...
    groupInfo = getPredictions("/home/edens-reject/squirrel/SQUIRREL-Web-App/5Dif/"+grIn[0].strip())
...
groupsIds = readGroups('files/5DiffGroupsTest.txt')
satO = {}
maxMin = {}
fScore = {}
ndcg = {}
...
file = open('files/Recommended_Movies_5_var.txt', 'w')
iter_scores = open('files/Scores_Per_Round_5_var.txt', 'w')
